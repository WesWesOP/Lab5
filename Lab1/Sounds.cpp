...
unsigned int Sounds::soundLoad(const char* filename)
{
	bool found = false;
...
void Sounds::soundDelete(unsigned int id)
{}

void Sounds::soundPlay(unsigned int id)
{
	alSourcePlay(id);
}
void Sounds::soundPlay(unsigned int id, glm::vec3& pos)
{
	alSource3f(id, AL_POSITION, pos.x, pos.y, pos.z);
	alSourcePlay(id);
}
void Sounds::soundStop(unsigned int id)
{
	alSourceStop(id);
}
void Sounds::listenerSet(glm::vec3& pos, glm::vec3& camLookAt)
{
