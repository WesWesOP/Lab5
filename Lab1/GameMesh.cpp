...
void GameMesh::init(Vertex* vertices, unsigned int numVertices, unsigned int* indices, unsigned int numIndices)
{
	IndexedModel model;
...
void GameMesh::modelInit(const IndexedModel& model)
{
...
void GameMesh::modelLoad(const std::string& filename)
{
