...
float Screen::getW() { return screenW; } //getters
float Screen::getH() { return screenH; }
...
void Screen::buffSwap()
{
	SDL_GL_SwapWindow(sdlWindow); //swap buffers
}

void Screen::screenClear(float r, float g, float b, float a)
{
...
void Screen::screenInit()
{
	...
	sdlWindow = SDL_CreateWindow("Game Window", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, (int)screenW, (int)screenH, SDL_WINDOW_OPENGL); // create window
